  ...
  function Check () {
   ...
   if (c.length==0) {
    ...
    if (isNaN(n2)==true) {
     ...
     document.getElementById("num").value=n2;
...
<div class="text">
  <center>
    <input id=num type=number size=4 min=1000 max=9999 name=number maxlength=4 size=4><input type=Button value="Ход" onClick="Check()">
    <br/><br/>
